...
var _class = function (_Phaser$Sprite) {
    ...
    function _class(_ref) {
        ...
        _this.lifespan = 2000;
        _this.body.drag.set(50);
        _this.rotation = rotation;
        game.physics.arcade.accelerationFromRotation(_this.rotation, 520, _this.body.velocity);
        return _this;
    }
...
var planets = exports.planets = ['jupiter', 'mars', 'mercure', 'neptune', 'saturne', 'soleil', 'terre', 'uranus', 'venus'];
...
var _class = function (_Phaser$Sprite) {
  ...
  _createClass(_class, [{
    ...
    key: 'applyGravityTo',
    value: function applyGravityTo(object) {
      var distance = new _phaser2.default.Point(this.body.x - object.body.x, this.body.y - object.body.y);
...
var _Game = __webpack_require__(/*! ./states/Game */ 132);
...
__webpack_require__(/*! regenerator-runtime/runtime */ 320);
...
var _class = function (_Phaser$Sprite) {
  ...
  _createClass(_class, [{
    ...
    value: function update() {
      ...
      var cameraBounds = new _phaser2.default.Rectangle(this.game.camera.x, this.game.camera.y, this.game.camera.width, this.game.camera.height);
      ...
      if (cameraBounds.contains(this.towards.x, this.towards.y)) {
        ...
        var direction = new _phaser2.default.Point(this.towards.x, this.towards.y);
        ...
        this.angle = _phaser2.default.Math.radToDeg(_phaser2.default.Point.angle(this.position, new _phaser2.default.Point(this.x + this.body.velocity.x, this.y + this.body.velocity.y)));

        var arrowBounds = new _phaser2.default.Rectangle(this.game.camera.x + 25, this.game.camera.y + 75, this.game.camera.width - 50, this.game.camera.height - 100);

        this.x = _phaser2.default.Math.clamp(this.x, arrowBounds.x, arrowBounds.x + arrowBounds.width);
        this.y = _phaser2.default.Math.clamp(this.y, arrowBounds.y, arrowBounds.y + arrowBounds.height);
      }
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    var direction = new _phaser2.default.Point(speedX, speedY);
    _this.body.velocity = direction;

    var randomAngle = 45 + _phaser2.default.Math.radToDeg(_phaser2.default.Point.angle(_this.position, new _phaser2.default.Point(_this.x + _this.body.velocity.x, _this.y + _this.body.velocity.y)));
    _this.body.setCircle(10, 5, 5);
    _this.anchor.x = 0.5;
    _this.anchor.y = 0.5;
    _this.angle = randomAngle;
  ...
  _createClass(_class, [{
    ...
    value: function update() {
      ...
      try {
        for (var _iterator = game.blackHoles[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var blackHole = _step.value;
      ...
      try {
        for (var _iterator2 = game.suns[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var sun = _step2.value;
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    game.physics.enable(_this, _phaser2.default.Physics.ARCADE);
    _this.gravity = 10;
    _this.gravityRadius = 50000;
    _this.eventHorizonRadius = 10000;
  ...
  _createClass(_class, [{
    ...
    value: function applyGravityTo(object) {
      if (object !== null && object.body !== null) {
        var distance = new _phaser2.default.Point(this.body.center.x - object.body.center.x, this.body.center.y - object.body.center.y);
        ...
        if (distMagSq < this.gravityRadius) {
          ...
          if (distMagSq < this.eventHorizonRadius) {
            ...
            game.add.tween(object).to({ alpha: 0 }, 50, _phaser2.default.Easing.Linear.None, true, 0, 0, false);
            object.x = this.x;
            object.y = this.y;

            object.body.velocity = new _phaser2.default.Point(0, 0);
          }
        }
      }
    }
...
var _class = function (_Phaser$Sprite) {
  ...
  _createClass(_class, [{
    ...
    value: function update() {
      ...
      try {
        for (var _iterator = game.planets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      try {
        for (var _iterator2 = game.blackHoles[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var blackHole = _step2.value;
      ...
      try {
        for (var _iterator3 = game.suns[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var sun = _step3.value;
      ...
      if (this.alpha == 0 || this.health <= 0) {
        ...
        try {
          ...
          this.body.velocity = _phaser2.default.Point.subtract(this.game.player.body.center, this.body.center);
          this.body.velocity.normalize();
          ...
          if (this.firerate < 0 && playerIsNearby) {
            ...
            var newBullet = new _Bullet2.default({
              ...
              asset: 'green-bullet',
              rotation: _phaser2.default.Point.angle(this.game.player.body.center, this.body.center)
            });
...
var _Bullet = __webpack_require__(/*! ../sprites/Bullet */ 90);
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    _this.body.maxVelocity.set(movementSpeed);
    _this.fuel = _this.fuelMax = 1000000;
    _this.firerate = 10;
    _this.health = _this.maxHealth = 100;
    _this.score = 0;
    _this.body.mass = 3;
    _this.alpha = 1;
    _this.maxFireRate = 300;
    _this.fireRate = 300;
  ...
  _createClass(_class, [{
    ...
    value: function update() {
      ...
      if (this.firerate < 0 && this.health > 0) {
        if (game.input.keyboard.isDown(_phaser2.default.Keyboard.X)) {
          this.game.missile1.play();
          var missile = new _Bullet2.default({
            game: this.game,
            x: this.body.center.x,
            y: this.body.center.y,
            asset: 'missile',
    ...
    key: 'fuelTankIsEmpty',
    value: function fuelTankIsEmpty() {
      return this.fuel == 0;
    }
  }]);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function preload() {
      ...
      game.load.image('knightHawks', 'assets/fonts/knighthawks_font.png');
    }
  }, {
    key: 'render',
...
var _Asteroid = __webpack_require__(/*! ../sprites/Asteroid */ 124);

var _Asteroid2 = _interopRequireDefault(_Asteroid);

var _Robot = __webpack_require__(/*! ../sprites/Robot */ 128);

var _Robot2 = _interopRequireDefault(_Robot);

var _Planet = __webpack_require__(/*! ../sprites/Planet */ 91);

var _Planet2 = _interopRequireDefault(_Planet);

var _BlackHole = __webpack_require__(/*! ../sprites/BlackHole */ 125);

var _BlackHole2 = _interopRequireDefault(_BlackHole);

var _Coin = __webpack_require__(/*! ../sprites/Coin */ 126);

var _Coin2 = _interopRequireDefault(_Coin);

var _Sun = __webpack_require__(/*! ../sprites/Sun */ 130);

var _Sun2 = _interopRequireDefault(_Sun);

var _Flag = __webpack_require__(/*! ../sprites/Flag */ 127);

var _Flag2 = _interopRequireDefault(_Flag);

var _Arrow = __webpack_require__(/*! ../sprites/Arrow */ 123);
...
var _class = function (_Phaser$State) {
    ...
    _createClass(_class, [{
        ...
        value: function create() {
            ...
            this.player = new _Ship2.default({
                game: this,
            ...
            //Add HUD info
            this.fuelText = game.add.retroFont('knightHawks', 31, 25, _phaser2.default.RetroFont.TEXT_SET2, 10, 1, 0);
            var fuelTextImage = game.add.image(362, 35, this.fuelText);
            fuelTextImage.tint = 0xFF7766;
            fuelTextImage.fixedToCamera = true;

            //health text
            this.healthText = game.add.retroFont('knightHawks', 31, 25, _phaser2.default.RetroFont.TEXT_SET2, 10, 1, 0);
            var healthTextImage = game.add.image(362, 5, this.healthText);
            healthTextImage.tint = 0x28bb35;
            healthTextImage.fixedToCamera = true;

            //score text
            this.scoreText = game.add.retroFont('knightHawks', 31, 25, _phaser2.default.RetroFont.TEXT_SET2, 10, 1, 0);
            var scoreTextImage = game.add.image(5, 5, this.scoreText);
            scoreTextImage.tint = 0xFFD700;
            scoreTextImage.fixedToCamera = true;

            //high score text
            this.highScoreText = game.add.retroFont('knightHawks', 31, 25, _phaser2.default.RetroFont.TEXT_SET2, 10, 1, 0);
            ...
            //game over text
            this.gameOverText = game.add.retroFont('knightHawks', 31, 25, _phaser2.default.RetroFont.TEXT_SET2, 10, 1, 0);
            ...
            this.weapon.bulletKillType = _phaser2.default.Weapon.KILL_LIFESPAN;
            ...
            var shootSignal = new _phaser2.default.Signal();
            ...
            this.specialWeapon1.bulletKillType = _phaser2.default.Weapon.KILL_LIFESPAN;
            ...
            this.specialWeapon1.actualFire = function (shooter, weapon) {
                if (weapon.game.time.time < weapon.nextFire) {
                    return;
                }
                ...
                for (var dir = -2; dir <= 2; dir++) {
                    weapon.fire(shooter, shooter.position.x + (c + spread * dir) % (Math.PI * 2), shooter.position.y + (s - spread * dir) % (Math.PI * 2));
                }
            ...
            this.musics = [game.add.audio('mars', 0.5), game.add.audio('mercury', 0.5), game.add.audio('venus', 0.5), game.add.audio('map', 0.5)];
        ...
        value: function update() {
            ...
            if (game.input.keyboard.isDown(_phaser2.default.Keyboard.SPACEBAR) && this.player.health > 0) {
        ...
        key: 'playerCollideFlag',
        value: function playerCollideFlag(player, flag) {
            var sun = this.game.suns[0];
        ...
        key: 'playerCollideRobot',
        value: function playerCollideRobot(player, robot) {
            this.checkIfPlayerStillAlive();

            this.makeExplosion((player.body.x + robot.body.x) / 2, (player.body.y + robot.body.y) / 2);
            if (robot.bigRobot) {
        ...
        value: function robotBulletCollidePlayerHandler(player, bullet) {
        ...
        key: 'missileHitsAsteroid',
        value: function missileHitsAsteroid(missile, asteroid) {
        ...
        key: 'robotCollideRobot',
        value: function robotCollideRobot(robot1, robot2) {
        ...
        key: 'asteroidCollideRobot',
        value: function asteroidCollideRobot(asteroid, robot) {
            this.makeExplosion((asteroid.body.x + robot.body.x) / 2, (asteroid.body.y + robot.body.y) / 2);
            if (robot.bigRobot) {
                this.makeExplosion(robot.body.centerX, robot.body.Y + robot.height);
                this.makeExplosion(robot.body.centerX, robot.body.Y);
            }
        ...
        value: function asteroidCollideOther(asteroid, asteroid2) {
            this.makeExplosion((asteroid.body.x + asteroid2.body.x) / 2, (asteroid.body.y + asteroid2.body.y) / 2);
            this.asteroids.remove(asteroid);
            this.asteroids.remove(asteroid2);
        }
    }, {
        key: 'bulletCollideAsteroidHandler',
        value: function bulletCollideAsteroidHandler(bullet, asteroid) {
            this.makeExplosion(asteroid.body.x, asteroid.body.y);
            this.asteroids.remove(asteroid);
        ...
        key: 'playerCollideCoin',
        value: function playerCollideCoin(player, coin) {
        ...
        key: 'playerCollideFuel',
        value: function playerCollideFuel(player, fuel) {
        ...
        key: 'playerCollideMedpack',
        value: function playerCollideMedpack(player, medpack) {
            this.powerupSound.play();
        ...
        key: 'playerCollideWeapon',
        value: function playerCollideWeapon(player, weaponCrate) {
            this.powerupSound.play();
            weaponCrate.kill();
        ...
        key: 'checkIfPlayerStillAlive',
        value: function checkIfPlayerStillAlive() {
        ...
        key: 'addPlanets',
        value: function addPlanets() {
            var planetDensity = 0.000004;
            var planetCount = this.world.width * this.world.height * planetDensity;
            this.game.planets = [];

            for (var i = 0; i < planetCount; i++) {
                var planet = new _Planet2.default({
                    game: this,
                    x: this.world.randomX,
                    y: this.world.randomY,
                    asset: _phaser2.default.ArrayUtils.getRandomItem(_Planet.planets)
                });
        ...
        value: function addBlackHoles() {
            ...
            for (var i = 0; i < blackHoleCount; i++) {
                ...
                var blackHole = new _BlackHole2.default({
                    game: this,
        ...
        key: 'addFlag',
        value: function addFlag(nearObject) {
            ...
            var newFlag = new _Flag2.default({
                game: this.game,
                x: x,
                y: y,
                asset: 'flag'
        ...
        key: 'addArrow',
        value: function addArrow(towardObject) {
            //console.log('creating arrow!')
            var newArrow = new _Arrow2.default({
                game: this.game,
                x: this.player.x,
                y: this.player.y,
                asset: 'arrow'
        ...
        key: 'drawBar',
        value: function drawBar(x, y, percentage) {
            var maxWidth = 150;
            var width = Math.ceil(percentage * maxWidth);
            var height = 20;
            var borderSize = 2;

            var color = _phaser2.default.Color.HSLtoRGB(percentage * 0.35, 0.75, 0.45);
            ...
            this.barGraphics.drawRect(x + borderSize, y + borderSize, Math.max(0, width - borderSize * 2), height - borderSize * 2);
        }
    }, {
        key: 'render',
        value: function render() {
        ...
        key: 'notifyPlayerDied',
        value: function notifyPlayerDied(message) {
        ...
        value: function addAsteroid() {
            ...
            if (this.asteroids.total < maxAsteroids) {
                ...
                if (asteroidRandom < chanceOfAsteroid) {
                    ...
                    var newAsteroid = new _Asteroid2.default({ game: this, x: newPosition.x, y: newPosition.y, asset: 'asteroid' });
        ...
        value: function addRobot() {
            ...
            if (this.robots.total < maxRobots) {
                ...
                if (robotRandom < chanceOfRobot) {
                    ...
                    var newRobot = new _Robot2.default({ game: this, x: newPosition.x, y: newPosition.y, asset: assetName });
        ...
        key: 'getPositionAlongEdge',
        value: function getPositionAlongEdge(randomSeed, seedRange) {
            var xPos, yPos;
        ...
        key: 'createRocketEmitters',
        value: function createRocketEmitters() {
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function preload() {
      ...
      try {
        for (var _iterator = _Planet.planets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var planet = _step.value;
...
module.exports = __webpack_require__(/*! E:\git_projects\hackathons\killer-robots\src\main.js */120);
